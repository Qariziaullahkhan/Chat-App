...
import 'package:chat_app/ui/screens/bottom_navigation/chat_list/chatlist_viewmodel.dart';
...
class ChatTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      onTap: onTap,
  tileColor: grey.withAlpha((0.12 * 255).round()),
      contentPadding: EdgeInsets.symmetric(horizontal: 10.w, vertical: 3),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.r)),
      leading: user.imageUrl == null
          ? CircleAvatar(
              backgroundColor: grey.withAlpha((0.5 * 255).round()),
              radius: 25,
  ...
  String getTime() {
    ...
    log("Last message time: $lastMessageTime");
